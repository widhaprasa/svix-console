      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="text-center">
            <h1 className="text-2xl font-semibold tracking-tight mb-4">Endpoints</h1>
            <p className="text-muted-foreground">Please select an application to view its endpoints.</p>
          </div>
        </div>
      </div>
    );
